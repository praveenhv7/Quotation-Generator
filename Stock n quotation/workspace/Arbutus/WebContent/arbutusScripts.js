...
function sendData()
{
	GetData();
	alert("called");
		$.ajax({url:"/Arbutus/Controller?argument=insert",
		type:"POST",
...
function getData()
{
$.ajax({url:"/Arbutus/Controller?argument=getMake",
	type:"POST",
	async:false,
...
function insertCust()
{
	...
	$.ajax({url:"/Arbutus/Controller?argument=insertCust",
		type:"POST",
...
function findCompany()
{
	...
	$.ajax({url:"/Arbutus/Controller?argument=getCompany",
		type:"POST",
		data:{"cName":name},
		async:true,
		success:function(result){
	...
	$('#company_name').autocomplete({
		...
		select:function(event,ui){
			...
			console.log(company_name);
				$.ajax({url:"/Arbutus/Controller?argument=getCustomerAddress",
				type:"POST",
				...
				$('#name').autocomplete({
					...
					select:function(event,ui){
						...
						var addressCust=customerObj[value].address;
						console.log(addressCust);
//						this.parentNode.parentNode.previousSibling.previousElementSibling.lastChild.lastChild.innerHTML=customerObj[value].address;
						document.getElementById("address").innerHTML=addressCust;
					}
...
function insertItems()
{
	...
	alert(make);
	 ...
	 jsonObjInsertDetails=JSON.stringify(ItemData);
	 console.log(ItemData);

	$.ajax({url:"/Arbutus/Controller?argument=insertItems",
		type:"POST",
		data:{"ItemData":jsonObjInsertDetails},
		async:false,
		success:function(result){alert("called");}
		});	
